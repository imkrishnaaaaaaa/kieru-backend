...
import com.kieru.backend.filter.RateLimitFilter;
...
public class SecurityConfig {
    ...
    private final RateLimitFilter rateLimitFilter; // 2. We inject the new RateLimitFilter here
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            // FIX: Anchor RateLimitFilter very early (before LogoutFilter)
            .addFilterBefore(rateLimitFilter, LogoutFilter.class)

            // FIX: Anchor AuthFilter before the standard Login filter
            // This ensures RateLimit runs BEFORE Auth
